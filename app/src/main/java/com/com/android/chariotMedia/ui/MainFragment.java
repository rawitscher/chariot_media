...
import com.com.android.chariotMedia.data.FetchVideoService;
import com.com.android.chariotMedia.data.VideoContract;
import com.com.android.chariotMedia.model.Video;
import com.com.android.chariotMedia.model.VideoCursorMapper;
import com.com.android.chariotMedia.presenter.CardPresenter;
import com.com.android.chariotMedia.presenter.GridItemPresenter;
import com.com.android.chariotMedia.presenter.IconHeaderItemPresenter;
import com.com.android.chariotMedia.recommendation.UpdateRecommendationsService;
...
public class MainFragment extends BrowseSupportFragment
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        if (BuildConfig.DEBUG) Log.d(TAG, "ON LOAD FINISHED FUNCTION BEGAN");
        if (data != null && data.moveToFirst()) {
            ...
            if (BuildConfig.DEBUG) Log.d(TAG, "STARTING INTENT TO FETCH VIDEOS");
    ...
    public void onLoaderReset(Loader<Cursor> loader) {
        if (BuildConfig.DEBUG) Log.d(TAG, "STARTING ON LOADER RESET");
