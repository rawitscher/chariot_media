...
import com.com.android.chariotMedia.presenter.DetailsDescriptionPresenter;
...
public class VideoDetailsFragment extends DetailsSupportFragment
    ...
    private void setupDetailsOverviewRow() {
        ...
        adapter.set(ACTION_WATCH_MOVIE, new Action(ACTION_WATCH_MOVIE, getResources()
                .getString(R.string.watch_film)));
