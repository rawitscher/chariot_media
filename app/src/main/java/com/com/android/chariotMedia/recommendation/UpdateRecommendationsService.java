...
package com.com.android.chariotMedia.recommendation;
...
import com.com.android.chariotMedia.ui.VideoDetailsActivity;
...
public class UpdateRecommendationsService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (!sharedPreferences.getBoolean(getString(R.string.pref_key_recommendations), true)) {
            if (BuildConfig.DEBUG)Log.d(TAG, "Recommendations disabled");
